...
-- DROP CONSTRAINT 
-- ALTER TABLE ATTENDS DROP CONSTRAINT ATTENDS_WORKSHOPS_FK;
...
CREATE TABLE LOCAL_COMMITTEES (
	...
	CONSTRAINT LOCAL_COMMITTEES_UNI_FK FOREIGN KEY (LC_uni) REFERENCES UNIVERSITIES (UNI_id)
);
...
CREATE TABLE STUDENTS (
	...
	CONSTRAINT STUDENTS_UNIVERSITIES_FK FOREIGN KEY (STUD_uni) REFERENCES UNIVERSITIES (UNI_id)
);
...
CREATE TABLE WORKSHOPS (
	WS_id				NUMBER (4) NOT NULL AUTO_INCREMENT, --[?] AUTO_INCREMENT will work ?
	...
	CONSTRAINT WORKSHOPS_LC_FK FOREIGN KEY (WS_organier) REFERENCES LOCAL_COMMITTEES (LC_id) ON DELETE CASCADE,
...
/* CREATE SEQUENCE WORKSHOPRS_SEQ
	START WITH 1
	INCREMENT BY 1; */ --[?] AUTO_INCREMENT will work ?

CREATE SEQUENCE COMPANIES_SEQ
	START WITH 1
	INCREMENT BY 1;

CREATE SEQUENCE LOCAL_COMMITTEES_SEQ
	START WITH 1
	INCREMENT BY 1;
